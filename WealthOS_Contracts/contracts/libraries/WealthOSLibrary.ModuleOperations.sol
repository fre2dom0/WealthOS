...
library WealthOSLibrary_ModuleOperations {
    ...
    function withdrawToken(
        ...
        for (uint i; i < len;) {
            ...
            emit WealthOSTypes.ModuleTokenWithdraw(_vaultOfUser, module, token, amount);
    ...
    internal {
        ...
        for (uint i; i < len;) {
            ...
            emit WealthOSTypes.ModuleNativeTokenWithdraw(_vaultOfUser, module, amount);
            unchecked { ++i; }
        }
    }
    ...
    internal {
        ...
        for (uint i; i < len;) {
            ...
            emit WealthOSTypes.ModuleTokenDeposited(_vaultOfUser, module, token, amount);
    ...
    function depositNative(
        ...
        for (uint256 i = 0; i < len;) {
            ...
            emit WealthOSTypes.ModuleNativeTokenDeposited(_vaultOfUser, module, amount);
