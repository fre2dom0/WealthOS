    ...
    */
    function depositToken(
        ...
        for (uint i; i < len;) {
            ...
            emit WealthOSTypes.TokenDeposited(user, token, amount, block.timestamp);
    ...
    function withdrawToken(
        ...
        for (uint i; i < len;) {
            ...
            emit WealthOSTypes.TokenWithdrawn(user, token, amount, block.timestamp);
    ...
    function withdrawNative(
        ...
        emit WealthOSTypes.NativeTokenWithdrawn(user, amount, block.timestamp);
    }
