...
import WALLET_CONFIG, { servantClient, servantContractWithServantClient } from "../configs/chain.config.js";
...
export const servantExecuteService = async (userAddress: `0x${string}`, contractAddress: `0x${string}`, functionName: string, args: string[], abi: Abi) => {
    ...
    const servantAccountAddress = WALLET_CONFIG.servant_account_address;
