...
import WALLET_CONFIG from '../configs/chain.config.js'
...
export const servantClient: Client<HttpTransport<undefined, false>> = createBlockchainClient(WALLET_CONFIG.servant_account_private_key);
export const ownerClient: Client<HttpTransport<undefined, false>> = createBlockchainClient(WALLET_CONFIG.owner_account_private_key);

export const servantContractWithServantClient = getContract({
    address: WALLET_CONFIG.servant_contract_address,
    abi: ABI, 
